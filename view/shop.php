            ...
            <div class="container" id="destaques-produtos-container"  >
                ...
                <div id="destaques-produtos">
                  	...
                  	<div class="item" ng-repeat="produto in produtos">
                   	...
                   	<button type="button" id="btn-destaques-prev"><i class="fa fa-angle-left"></i></button>
				        <button type="button" id="btn-destaques-next"><i class="fa fa-angle-right"></i></button>
                	...
                	<div class="col-md-3" ng-repeat="produto in produtos">
                	   <div class="box-produto-info">
                	   	<a href="#">
                	   		...
                	   		<div class="text-qtd-reviews text-arial-cinza">{{produto.total_reviws}}</div>
                	   		<div class="text-valor text-roxo">R$ {{produto.total}}</div>
                	   		<div class="texto-parcelado text-arial-cinza">{{produto.parcelas}}x de {{produto.parcela}} sem Juros</div>       
                	   	</a>
                	   </div>
                	</div>
...
angular.module("shop", []).controller("destaque-controller", function($scope ,$http){
      ...
      var initCarousel = function(){
          ...
          $("#destaques-produtos").owlCarousel({
           ...
           var owlDestaque = $("#destaques-produtos").data('owlCarousel');

          $('#btn-destaques-prev').on("click", function(){

          owlDestaque.prev();

          });

          $('#btn-destaques-next').on("click", function(){
